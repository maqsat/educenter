...
(function(window, document, Chartist){
  ...
  function createChart(options) {
    ...
    data.raw.series.forEach(function(series, seriesIndex) {
      ...
      // Write attributes to series value element. If series name or meta is undefined the attributes will not be written
      seriesElement.attr({
      ...
      if(seriesOptions.showArea && axisY.range) {
        ...
        path.splitByCommand('M').filter(function onlySolidSegments(pathSegment) {
          ...
          // and adding the created DOM elements to the correct series value
...
(function(window, document, Chartist){
  ...
  var defaultOptions = {
    ...
    // Specify the distance in pixel of bars in a value
  ...
  function createChart(options) {
    ...
    data.raw.series.forEach(function(series, seriesIndex) {
      ...
      // Adding the series value to the series element
...
(function(window, document, Chartist) {
  ...
  function createChart(options) {
    ...
    //if we need to show labels we create the label value now
   ...
   * @memberof Chartist.Pie
   * @param {String|Node} query A selector query string or directly a DOM element
   * @param {Object} data The data object in the pie chart needs to have a series property with a one dimensional data array. The values will be normalized against each other and don't necessarily need to be in percentage. The series property can also be an array of value objects that contain a value property and a className property to override the CSS class name for the series value.
   * @param {Object} [options] The options object with options that override the default options. Check the examples for a detailed list.
   * @param {Array} [responsiveOptions] Specify an array of responsive option arrays which are a media query and options object pair => [[mediaQueryString, optionsObject],[more...]]
