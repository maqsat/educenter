    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li> <a class="waves-effect waves-dark" href="/specialty" aria-expanded="false"><i class="mdi mdi-book-open-variant"></i><span class="hide-menu">Специальность</span></a>
                </li>
                <li> <a class="waves-effect waves-dark" href="/group" aria-expanded="false"><i class="mdi mdi-account-multiple"></i><span class="hide-menu">Группы</span></a>
                </li>
